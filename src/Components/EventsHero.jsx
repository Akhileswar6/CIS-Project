    ...
    return(
        <div className="flex flex-col gap-20 px-15 max-md:px-3 max-sm:gap-15">
            <div className="flex flex-col gap-2 items-center justify-center text-center">
                <h3 className="text-3xl font-semibold max-lg:text-2xl max-md:text-xl">Events & Workshops</h3>
            ...
            <div className="flex gap-5 max-sm:flex-wrap items-center justify-center max-sm:gap-2">
                {ImportantPrograms.map((program, index) => (
                    <div key={index} className="p-5 border-1 flex justify-center flex-col items-center gap-5 border-gray-900 rounded-md text-center max-sm:gap-3">
                        ...
                        <h6 className="text-lg font-semibold max-sm:text-base">{program.name}</h6>
