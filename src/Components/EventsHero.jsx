    ...
    return(
        <div className="flex flex-col gap-20 px-15">
            <div className="flex flex-col gap-2 items-center justify-center">
                <h3 className="text-3xl font-semibold">Events & Workshops</h3>
                <p className="text-gray-500">Discover our comprehensive cybersecurity events, from hands-on workshops to competitive challenges</p>
            </div>
