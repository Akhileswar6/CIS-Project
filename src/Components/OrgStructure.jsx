...
const OrgStructure = () => {
    return(
        <div className="flex flex-col px-10 py-15 gap-5 max-md:px-3">
            <div className="text-center space-y-3">
                <h3 className="text-3xl font-semibold max-lg:text-2xl max-md:text-xl">Organizational Structure</h3>
                <p className="text-gray-500 max-lg:text-base text-lg max-md:text-sm">Oue dedicated team working together to achieve excellence in cyber field.</p>
            </div>
            <div className="grid grid-cols-3 gap-5 pt-7 max-lg:grid-cols-2 max-sm:grid-cols-1">
                {OrganizationalStructure.map((org, index) => (
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h6 className="text-lg font-medium max-md:text-base">{org.name}</h6>
                    </div>
