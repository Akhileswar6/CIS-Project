...
const SecurityToolsGuides = () => {
    return(
        <div className="flex flex-col pt-10">
            <h6 className="text-center text-xl font-semibold">Security Tools & Guides</h6>
            <div className="grid grid-cols-3 px-10 py-15 gap-3">
                {SecurityToolsWithGuides.map((tool) => (
                    <div className="border-1 p-5 flex flex-col justify-center rounded-md text-sm border-gray-900">
                        ...
                        <p className="pt-4 text-lg font-semibold">{tool.name}</p>
                        ...
                        <button className="flex justify-center text-md"><a href="" className="flex justify-center items-center pt-7 gap-2 w-fit"><Book size={16} /> View Guide</a></button>
                    </div>
                ))}
            </div>
        </div>
