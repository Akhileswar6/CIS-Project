        ...
        <div className="px-10 pt-36 flex flex-col w-full gap-y-2 max-md:px-3">
            ...
            <div className="grid grid-cols-3 py-10 gap-4 w-full max-lg:grid-cols-2 max-sm:grid-cols-1 max-md:gap-2">
                {UpcomingEventsData.map((ent) => (
                    <div className="border-1 p-5 border-gray-900 rounded-xl flex flex-col gap-y-7 max-md:gap-y-4">
                        ...
                        <div>
                            <p className="text-xl max-lg:text-lg max-md:text-base font-semibold">{ent.name}</p>
                            <p className="text-sm flex items-center text-gray-500 gap-2 mt-2"><Clock size={13} />{ent.time}</p>
                        </div>
